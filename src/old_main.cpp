...
//    while (std::cin.get() != 'q') {
    ...
    std::cout << "Satellite received request: " << request.to_string() << std::endl;
...
void run_ground_station_client() {
    ...
    std::cout << "Ground station sent request: " << request.to_string() << std::endl;
    ...
    std::cout << "Ground station received response: " << response.to_string() << std::endl;
